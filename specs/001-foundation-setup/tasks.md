...
- [x] T018 [US3] Initialize Alembic settings at `backend/alembic.ini` and configuration folder at `backend/alembic/`
- [x] T019 [US3] Create database models import registry file at `backend/app/db/base.py`
...
- [x] T022b [US3] Manually edit the autogenerated Alembic migration script to enable Row-Level Security (RLS) and define tenant isolation policies on all 6 tenant tables (users, assistants, documents, conversations, messages, quota_logs) before running it
