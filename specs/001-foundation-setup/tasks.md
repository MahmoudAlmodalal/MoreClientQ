...
- [/] T022b [US3] Manually edit the autogenerated Alembic migration script to enable Row-Level Security (RLS) and define tenant isolation policies on all 6 tenant tables (users, assistants, documents, conversations, messages, quota_logs) before running it
